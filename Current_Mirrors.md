...
### DC Analysis:
<img width="650" alt="dc2" src="https://github.com/user-attachments/assets/efd4d4aa-8a90-4d27-9f93-8174a86e53ec" />


### Transient Analysis:
<img width="650" alt="tr2" src="https://github.com/user-attachments/assets/54db8572-167b-41f5-a17c-1b2ad6d73ce6" />


### AC Analysis:
<img width="650" alt="ac2" src="https://github.com/user-attachments/assets/53578d83-83eb-4389-9493-9464e69e73e3" />
...
|-----------|---------------------|--------|
|  M1       |   0.2775       | 16.07354  |           
|  M2       |   0.277515       | 16.07354  |     
|  M3       |   0.277515         | 16.07354  |

### Comparision with W/L ratio is 1 with different value of W and L:

| Iref  | Ix (Expected) | Ix (Practical) | (W/L)1 | (W/L)2 | (W/L)3 | Vx     | V out  |
|--------|---------------|--------------|--------|--------|--------|--------|-------|
| 277.5μm  | 277.5μm         | 277.545μm        | 1      | 1      | 1  | 0.69669V | 0.695388V |
| 277.5μm  | 277.5μm         | 277.545μm      | 1      | 1      | 1    |0.607096V | 0.604044V |
| 277.5μm  | 277.5μm        | 277.515μm      | 1      | 1      | 1   | 0.542983V | 0.541344V |
